...
entitiesImport=pd.read_sql_query(text("select entity_id, numero_documento, nombre_razon from acc.entities"),motor)
entitiesImport.to_sql("entities",con=c, if_exists='append', index=False)